    ...
    <>
      <div className='w-full h-17 m-0 bg-gray-900 text-white flex justify-around items-center'>
        ...
        <div className='m-1 p-2 w-40 ml-5'>
          {user.country ?
            <div>
              ...
              <h1 className='text-amber-600 font-semibold'>{user.country}</h1>
            </div>
            : ''
          }
        </div>
        ...
        <ul className='w-100 h-20 flex justify-around items-center'>
          <li><NavLink to='/' className={({ isActive }) => isActive ? 'text-amber-600 font-semibold' : 'text-white'}>Home</NavLink></li>

          <li><NavLink to='/myItems' className={({ isActive }) => isActive ? 'text-amber-600 font-semibold' : 'text-white'}>My Items</NavLink></li>

          <li><NavLink to='/profile' className={({ isActive }) => isActive ? 'text-amber-600 font-semibold' : 'text-white'}>Profile</NavLink></li>
